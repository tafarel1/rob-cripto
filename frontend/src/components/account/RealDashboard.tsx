  ...
  return (
    <div className="w-full max-w-7xl mx-auto p-6 space-y-6 bg-background text-foreground">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <DollarIcon className="h-4 w-4 text-blue-600" />
          </CardHeader>
          <CardContent>
            ...
            <div className={`text-xs mt-1 flex items-center ${
              ...
              {performance.totalProfit >= 0 ? <TrendingUpIcon className="w-3 h-3 mr-1" /> : <TrendingDownIcon className="w-3 h-3 mr-1" />}
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center">
              <ShieldIcon className="w-5 h-5 mr-2 text-orange-600" />
              Gestão de Risco
            </CardTitle>
          </CardHeader>
          <CardContent>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center">
            <AlertTriangleIcon className="w-5 h-5 mr-2 text-red-700" />
