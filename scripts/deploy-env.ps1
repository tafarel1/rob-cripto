...
function Info($m){ Write-Host "[env] $m" }
...
try {
    ...
    # Garantir diretórios conforme parâmetros informados
    ...
    Info ("Executando orquestrador: {0}-{1} (modo {2})" -f $Namespace,$Env,$Mode)
    & $runner @args
