...
import { BacktestResult } from '../../../shared/types.js';
import { MonteCarloResult } from './quantBacktester.js';
...
export class ReportGenerator {
  ...
  public generateMarkdownReport(
    ...
    extraMetrics: { calmar: number; omega: number }
  ): string {
...
| Metric | Value |
|--------|-------|
| Total Return | ${((metrics.totalReturn || 0) * 100).toFixed(2)}% |
...
- Avg Win: ${(metrics.averageWin || 0).toFixed(2)}
- Avg Loss: ${(metrics.averageLoss || 0).toFixed(2)}
